...
class AppLocalizationsEn extends AppLocalizations {
  ...
  String get foundationReadyMessage =>
      'Anas Life OS is ready for its next approved sprint. '
      'No personal data or product features are active yet.';
  ...
  String get foundationErrorMessage =>
      'The local encrypted database engine could not be verified. '
      'No data was created. Retry after checking the installation.';
