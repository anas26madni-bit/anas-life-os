...
void main() {
  test('schedules with graceful inexact fallback and synchronizes events', () async {
    ...
    final created =
        (await useCases.create(
            ...
            .value;
    expect(scheduler.scheduled.single.occurrence.precision, ReminderSchedulePrecision.inexact);
    ...
    expect(
      (await useCases.missedReport() as Success<List<ReminderHistoryEntity>>).value,
      hasLength(1),
    );
  });
}
