...
void main() {
  testWidgets('security screen supports Urdu RTL and 48dp controls', (
    tester,
  ) async {
    ...
    expect(
      Directionality.of(tester.element(find.byType(SecurityPage))),
      TextDirection.rtl,
    );
    expect(
...
final class _FakeSecurityPlatform implements SecurityPlatform {
  @override
  Future<NativeSecurityStatus> status() async => const NativeSecurityStatus(
    hasPin: false,
