...
void main() {
  final appRoot =
      Directory.current.path.endsWith('${Platform.pathSeparator}app')
      ? Directory.current
      : Directory('app');

  String read(String relativePath) => File(
    '${appRoot.path}${Platform.pathSeparator}$relativePath',
  ).readAsStringSync();
  ...
  test('Future Release packages and routes remain absent', () {
    ...
    for (final forbidden in <String>['/ai', '/plugins', '/cloud', '/wear']) {
