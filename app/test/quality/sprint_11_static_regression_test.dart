...
void main() {
  test('production code has no polling, unmanaged wake locks, or hardcoded UI colors', () {
  ...
  test('Android background work is constrained and declares no location access', () {
