...
| Sprint 12 | Release Candidate | In progress | None | Final fixes/regression/docs/performance/security/accessibility/release notes/candidate |

## Current continuation point

Sprint 1-11 and the authorized UI/navigation gap closure are complete. Sprint 12
release-candidate validation is in progress from the verified Sprint 11 merge.
