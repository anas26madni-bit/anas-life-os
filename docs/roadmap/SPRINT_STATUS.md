...
| Sprint 8 | Statistics | In progress | None; formulas approved | Reports/charts/productivity/completion/delay/trends |
...
Sprint 1-7 and the authorized UI/navigation gap closure are complete. Sprint 8
Statistics implementation is in progress on its dedicated branch.
